...
<head>
<meta charset="utf-8"> 
<title>Midwest Copier Exchange</title>
        ...
        <div class="main-nav">
            <ul class="secondary-menu sf-menu" id="menu-global-group">
                ...
                <li class="menu-item menu-item-type-post_type menu-item-object-group menu-item-501" id="menu-item-501">
                    <a href="https://arcoa.impactpreview.com/group/contact-us/">CONTACT US</a>
                </li>
            </ul>
        </div>
...
<header class="site-header" id="masthead" itemscope="itemscope" itemtype="http://schema.org/WPHeader">
    <div class="inside-header grid-container grid-parent">
        <div class="before-header">
            ...
            <div class="site-logo">
                <a href="https://arcoa.impactpreview.com/" rel="home" title="ARCOA"><img alt="ARCOA" class="header-image" src="/assets/images/arcoa_logo_group.png" title="ARCOA"></a>
            </div>
            <style type="text/css">
            ...
            <div class="site-logo-alt site-logo-exchange">
                <a href="/" rel="home" title="ARCOA - exchange"><img alt="ARCOA - exchange" class="header-image" src="/assets/images/arcoa_logo_exchange.png" title="ARCOA - exchange"></a>
            </div>
        </div>
    </div><!-- .inside-header -->
</header>