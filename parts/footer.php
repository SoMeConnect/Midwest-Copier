            ...
            <div class="inside-footer-widgets">
                ...
                <div class="footer-widget-2 grid-parent grid-20 tablet-grid-50 mobile-grid-100">
                    <aside class="widget inner-padding widget_text" id="text-7">
                        <div class="textwidget">
                            <p><a href="tel:847-599-9001">847-599-9001</a><br>
                            Toll Free <a href="tel:800-487-6798">800-487-6798</a><br>
                            <a href="mailto:info@arcoausa.com">info@arcoausa.com</a></p>
                        </div>
                    </aside>
                ...
                <div class="footer-widget-4 grid-parent grid-20 tablet-grid-50 mobile-grid-100">
                    <aside class="widget inner-padding widget_sp_image" id="widget_sp_image-7">
                        <img class="attachment-full" height="4" src="https://arcoa.impactpreview.com/wp-content/uploads/333d47.png" style="max-width: 100%;" width="6">
                    </aside>
                </div>
                <div class="footer-widget-5 grid-parent grid-20 tablet-grid-50 mobile-grid-100">
                    <aside class="widget inner-padding widget_text" id="text-8">
                        <div class="textwidget">
                            <p>©2017 ARCOA Group. All Rights Reserved.</p>
                        </div>
                    </aside>
    ...
    <footer class="site-info" itemscope="itemscope" itemtype="http://schema.org/WPFooter">
        <div class="inside-site-info grid-container grid-parent">
            <div class="copyright-bar">
                ©2017 ARCOA Group. All Rights Reserved.<br>
