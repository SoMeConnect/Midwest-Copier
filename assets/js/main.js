jQuery(document).ready(function($) {
    ...
    $('.confirm').on('click',function() {
        var quantity = $('.option-quantity').val()?$('.option-quantity').val():alert('Please fill the field.'),
        equipment = $('.option-equipment').val()?$('.option-equipment').val():alert('Please fill the field.'),
        make = $('.option-make').val()?$('.option-make').val():alert('Please fill the field.'),
        model = $('.option-model').val()?$('.option-model').val():alert('Please fill the field.'),
        comments = $('.option-comments').val()?$('.option-comments').val():alert('Please fill the field.');
